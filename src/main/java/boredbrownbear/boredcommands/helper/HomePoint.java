...
public class HomePoint
{
	...
	private static SaveFile homesSaveFile = new SaveFile("homes.txt", BoredCommands.getWorldDir().toString()+"/boredcommands/homes/");
	...
	public HomePoint(String info) 
	{
		...
		{
			System.err.println("Exception on attempting to rebuild WarpPoint from String.");
			UUID="Error";
			homename = "Error";
