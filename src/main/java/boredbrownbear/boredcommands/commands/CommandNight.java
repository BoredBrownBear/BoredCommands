...
public class CommandNight {
    ...
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        LiteralArgumentBuilder<ServerCommandSource> literal = CommandManager.literal("night");
    ...
    public static int execute(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        player.sendSystemMessage(new TranslatableText("commands.night.done").setStyle(MyStyle.Green), player.getUuid());
