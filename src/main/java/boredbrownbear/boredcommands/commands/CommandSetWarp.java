    ...
    public static int execute(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        if (args == null || args == "") {
            ...
            if (warpPoint == null) {
                ...
                player.sendSystemMessage(new TranslatableText("commands.setwarp.done", warpPointName).setStyle(MyStyle.Green), playerUuid);
            } else {
                player.sendSystemMessage(new TranslatableText("commands.setwarp.failure", warpPointName).setStyle(MyStyle.Red), playerUuid);
            }
        }
